...
print("El promedio del uso de la memoria para un total de {} frames o imagenes es de {} MB".format(c,promMEM))
print("El promedio del tiempo que se demora en analizar un frame o una imagen es de {} s".format(promTIME))
